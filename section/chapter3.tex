...
\hline
Sebuah keadaan yang dimana sedang terjadi apa apa yang sedang diperbincangkan.&Selain keren juga harus terlihar rapih dan penuh pesona&Kondisi ini bisa kita bilang, kondisi yang ideal.\\
\hline
\end{tabular}
\label{table:contoh}
\end{table}
